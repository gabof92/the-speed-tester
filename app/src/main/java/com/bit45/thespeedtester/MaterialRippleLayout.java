...
/**
 * This class's imports where modified to use nineoldandroid library classes
 * in order to provide backwards compatibility for the animations
 */
...
public class MaterialRippleLayout extends FrameLayout {
    ...
    public MaterialRippleLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        /*Make sure to build project with attrs styleables declared or
        it will give an error with the R.styleable and wont let you rebuild*/
    ...
    private void startHover() {
        ...
        //hoverAnimator = ObjectAnimator.ofFloat(this, radiusProperty, 0f, 0f).setDuration(HOVER_DURATION);
    ...
    //Modified from original to be able tu use on Any API

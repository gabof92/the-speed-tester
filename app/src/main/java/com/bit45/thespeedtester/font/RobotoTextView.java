package com.bit45.thespeedtester.font;
...
public class RobotoTextView extends TextView {
    ...
    public static Typeface getRoboto(Context context, int typeface) {
        switch (typeface) {
            ...
            case Roboto.ALARM_CLOCK:
                if (Roboto.sAlarmClock == null) {
                    Roboto.sAlarmClock = Typeface.createFromAsset(context.getAssets(), "fonts/clock.otf");
                }
                return Roboto.sAlarmClock;
            case Roboto.INFO:
                if (Roboto.sInfo == null) {
                    Roboto.sInfo = Typeface.createFromAsset(context.getAssets(), "fonts/info.otf");
                }
                return Roboto.sInfo;
        }
    }
    ...
    public static class Roboto {
        ...
        */
        ...
        private static Typeface sAlarmClock;
        private static Typeface sInfo;
    }
}
